...
public class MultiBoxTracker {
  ...
  private int LastColor=0;String LastName="";
  ...
  private void processResults(
    ...
    if (objectTracker == null) {
      ...
      for (final Pair<Float, Recognition> potential : rectsToTrack) {
        ...
        String objectrecog=potential.second.getTitle();

        int color=COLORS[trackedObjects.size()];

          objectrecog = objectrecog.replace("person", "persona");
          objectrecog = objectrecog.replace("car", "carro");
          objectrecog = objectrecog.replace("cell phone", "celular");
          objectrecog = objectrecog.replace("remote", "control remoto");
          objectrecog = objectrecog.replace("dining table", "mesa");
          objectrecog = objectrecog.replace("cup", "taza");
          objectrecog = objectrecog.replace("bowl", "tazón");
          objectrecog = objectrecog.replace("spoon", "cuchara");
          objectrecog = objectrecog.replace("bottle", "botella");
          objectrecog = objectrecog.replace("book", "libro");
          objectrecog = objectrecog.replace("toilet", "Taza de baño");
          objectrecog = objectrecog.replace("tv", "televisión");
          objectrecog = objectrecog.replace("chair", "silla");
          objectrecog = objectrecog.replace("clock", "reloj");
          objectrecog = objectrecog.replace("toothbrush", "cepillo de dientes");
          objectrecog = objectrecog.replace("keyboard", "teclado");
          objectrecog = objectrecog.replace("bed", "cama");
          objectrecog = objectrecog.replace("cake", "pastel");
          objectrecog = objectrecog.replace("donut", "dona");
          objectrecog = objectrecog.replace("apple", "manzana");
          objectrecog = objectrecog.replace("wine glass", "copa");
          objectrecog = objectrecog.replace("knife", "cuchillo");
          objectrecog = objectrecog.replace("backpack", "mochila");
        objectrecog = objectrecog.replace("cat", "perro");
        objectrecog = objectrecog.replace("dog", "gato");
        objectrecog = objectrecog.replace("stop sign", "señalizacion");
        objectrecog = objectrecog.replace("traffic light", "semaforo");
        objectrecog = objectrecog.replace("motorcycle", "motocicleta");
        objectrecog = objectrecog.replace("tie", "corbata");
        objectrecog = objectrecog.replace("scissors", "tijeras");
        objectrecog = objectrecog.replace("teddy bear", "oso de peluche");

        trackedRecognition.title = objectrecog;
        trackedRecognition.color = COLORS[trackedObjects.size()];
          if(DetectorActivity.MandarMas) {
            DetectorActivity.LecturaObjetos.add(objectrecog);
            Log.i("lecturap: ","Envie algo");
          }else{
            Log.i("lecturap: ","No envie nada");
          }
